...
```
to change to numeric **as numeric**
...
1. Serial correlation structures:  
  - Compound symmetry  
  - General  
  - Auto-regressive of order 1 (AR1)  # famouns in agriculture 
...
> Different internal **CORCAR1**
Need to give factor for correlation
